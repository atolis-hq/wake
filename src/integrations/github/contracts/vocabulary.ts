...
// resumes a blocked/failed stage; /restart starts it in a fresh runner session;
// /extend grants one exhausted gate attempt.
// Kept as the single source of truth for both
