...
const versionModulePath = resolve(repoRoot, 'dist-next/src-next/bootstrap/version.js');
const { resolveWakeVersion } = await import('../dist-next/src-next/bootstrap/version.js');
...
console.log(`Embedded Wake version ${buildVersion} (src-next)`);
