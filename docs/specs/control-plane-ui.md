...
| --------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Needs human** | Wake is explicitly waiting on a person     | last sentinel `BLOCKED`, or the run is `awaiting-approval` (a `DONE` on an approval-gated stage), with no unhandled human reply yet                                                         |
